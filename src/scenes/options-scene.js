...
const OPTION_MENU_OPTION_INFO_MSG = Object.freeze({
    ...
    BATTLE_SCENE: 'Choose two display battle animations and effects or not.',
    ...
    CONFIRM: 'Save your changes and go back to the menu.',
})
...
export class OptionsScene extends Phaser.Scene {
    ...
    #updateTextSpeedGameObjects() {
        const textGameObjects = /** @type {Phaser.GameObjects.Text[]} */ (this.#textSpeedOptionTextGameObjects.getChildren())
    ...
    #updateBattleSceneOptionGameObjects() {
        const textGameObjects = /** @type {Phaser.GameObjects.Text[]} */ (this.#battleSceneOptionTextGameObjects.getChildren())
    ...
    #updateBattleStyleOptionGameObjects() {
        const textGameObjects = /** @type {Phaser.GameObjects.Text[]} */ (this.#battleStyleOptionTextGameObjects.getChildren())
